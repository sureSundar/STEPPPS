...
echo "==================================="
echo "Building TernaryBit OS v2.1 (STEPPPS Enhanced)"
echo "==================================="
...
# Assemble compact STEPPPS boot sector
nasm -f bin $BOOT_DIR/boot_compact.asm -o $BUILD_DIR/boot.bin

# Assemble STEPPPS enhanced stage 2
nasm -f bin $BOOT_DIR/stage2_steppps.asm -o $BUILD_DIR/stage2.bin
