...
void process_list(void) {
    kernel_print("\n=== Process List ===\n");
    kernel_print("PID 0: Kernel\n");
    kernel_print("PID 1: Shell\n");
}

void tbos_discover_devices(void) {
    kernel_print("Device discovery not yet implemented\n");
}

void tbos_list_devices(void) {
    kernel_print("No devices discovered yet\n");
}

void tbos_list_streams(void) {
    kernel_print("No active streams\n");
}

uint32_t tbos_start_audio_stream(uint32_t device_id) {
    kernel_print("Audio streaming not yet implemented\n");
    return 0;
}

uint32_t tbos_start_video_stream(uint32_t device_id) {
    kernel_print("Video streaming not yet implemented\n");
    return 0;
}

void tbos_stop_stream(uint32_t session_id) {
    kernel_print("Stream stopped\n");
}
